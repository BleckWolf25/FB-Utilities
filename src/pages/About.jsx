      ...
      <div className="max-w-6xl mx-auto">
        <div className="relative">
          ...
          <AnimatedElement
            ...
            customAnimation={{ direction: 'left', distance: 50, duration: 0.8 }}
          ...
          <div className="pt-20 md:pt-28 pb-16 relative z-10">
            ...
            <StaggerContainer staggerDelay={0.1} delayChildren={0.2}>
              ...
              <AnimateInView delay={1} className="text-2xl md:text-3xl font-semibold text-indigo-600 dark:text-indigo-400 mb-6">
                The duo behind FB-Utilities
              </AnimateInView>
              <AnimateInView delay={2} className="text-lg md:text-xl max-w-2xl text-gray-700 dark:text-gray-300 mb-8">
        ...
        {/* Our Story section */}
        <ParallaxContainer speed={-0.2} className="mt-16 mb-24">
          <AnimateInView delay={0} className="text-2xl font-semibold text-center mb-12 text-gray-900 dark:text-white">
            Our Story
          </AnimateInView>
        ...
        {/* Team section (using AnimateInView) */}
        <ParallaxContainer speed={-0.2} className="mt-24 mb-16">
          <AnimateInView delay={0} className="text-2xl font-semibold text-center mb-12 text-gray-900 dark:text-white">
            Meet Our Team
          </AnimateInView>
          <div className="grid md:grid-cols-3 gap-8">
            {teamMembers.map((member, index) => (
              <AnimateInView key={member.name} delay={index + 1}>
                <Card title={member.name} className="h-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300">
        ...
        {/* Values section (using AnimateInView) */}
        <ParallaxContainer speed={-0.2} className="mt-24 mb-16">
          <AnimateInView delay={0} className="text-2xl font-semibold text-center mb-12 text-gray-900 dark:text-white">
            Our Values
          </AnimateInView>
          <div className="grid md:grid-cols-3 gap-8">
            {FbValues.map((value, index) => (
              <AnimateInView key={value.title} delay={index + 1}>
        ...
        {/* CTA section (using AnimateInView and StaggerContainer) */}
        <AnimateInView
          variants={scaleInVariants}
          customAnimation={{ duration: 0.7, initialScale: 0.9 }}
